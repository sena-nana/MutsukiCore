...
pub const PLUGIN_ID: &str = "mutsukicore-codex-core";
...
fn plugin_snapshot() -> PluginSnapshot {
    PluginSnapshot {
        descriptor: PluginDescriptor {
            ...
            generation: 0,
            name: "MutsukiCore Codex Core".into(),
            description: "Codex app-server StrategyBackend for MutsukiCore runtime".into(),
...
mod tests {
    ...
    fn operation_backend_lists_plugin_and_filters_source_by_enabled_plugins() {
        let backend = CodexAppServerBackend::new(client_with_response(String::new()));
