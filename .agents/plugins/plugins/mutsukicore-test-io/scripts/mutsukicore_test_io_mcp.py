...
class TestIoServer:
    ...
    def _initialize_result(self) -> dict[str, JsonValue]:
        return {
            ...
            "instructions": (
                "Use these tools for local MutsukiCore process I/O tests. "
                "Prefer jsonl_request for stdio JSONL backend checks and always set timeouts."
            ),
        }
