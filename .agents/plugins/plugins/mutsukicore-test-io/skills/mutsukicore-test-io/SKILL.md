---
name: mutsukicore-test-io
description: Use when driving MutsukiCore backend or process I/O tests from Codex through the bundled MCP tools.
---

# MutsukiCore Test I/O

Use this skill when Codex needs to run local commands, drive a long-running
stdio process, or send JSONL requests while testing MutsukiCore behavior.
...
- Prefer `jsonl_request` for MutsukiCore stdio backend checks.
