...
| `RefParam` | `Annotated[Handle[T], RefArg(kind="...")]` | 从 payload 或 `ResourceHost` 解析 typed handle，并校验 kind | [dependency.py](../../mutsukibot/core/dependency.py) |
...
from mutsukibot.contracts import Handle, RefArg, RefArgSource
