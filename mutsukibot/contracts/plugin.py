...
面向用户的高层装饰器（``@command`` 等）位于 :mod:`mutsukibot.core.plugin`。
...
class PluginDep(Contract):
    ...
    schema_id: ClassVar[str] = "mutsukibot.plugin_dep"
...
class ContractDep(Contract):
    ...
    schema_id: ClassVar[str] = "mutsukibot.contract_dep"
    schema_version: ClassVar[str] = "1.0.0"
...
class ServiceDep(Contract):
    ...
    schema_id: ClassVar[str] = "mutsukibot.service_dep"
    schema_version: ClassVar[str] = "1.0.0"
