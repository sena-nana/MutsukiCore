# MutsukiCore Runtime Python

`mutsukicore-runtime-python` is the Python backend kit for the Rust-first
MutsukiCore runtime. It mirrors the Rust runtime contracts and provides an in-process
