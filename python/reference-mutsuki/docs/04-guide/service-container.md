...
代码：[mutsuki/core/container.py](../../mutsuki/core/container.py)。
...
[container.py:17-21](../../mutsuki/core/container.py#L17-L21)：
...
[container.py:23-30](../../mutsuki/core/container.py#L23-L30)：
...
[container.py:38-51](../../mutsuki/core/container.py#L38-L51)：
...
`Inject()` 是 [contracts/plugin.py:37-44](../../mutsuki/contracts/plugin.py#L37-L44) 定义的 sentinel：
...
Dependent 的 `ServiceParam` 看到默认值是 `Inject` 实例就认领（[dependency.py:138-142](../../mutsuki/core/dependency.py#L138-L142)），调用时执行：
...
`ServiceMode`（[contracts/service.py:9-11](../../mutsuki/contracts/service.py#L9-L11)）有两个值：
...
```python
from mutsuki.contracts.plugin import PluginDep, ServiceDep
