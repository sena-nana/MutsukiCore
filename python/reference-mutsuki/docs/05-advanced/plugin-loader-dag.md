...
代码：[mutsuki/core/loader.py](../../mutsuki/core/loader.py)。
...
[loader.py:77-90](../../mutsuki/core/loader.py#L77-L90)：
...
约定：`pyproject.toml` 里声明 `[project.entry-points."mutsuki.plugins"]`：
...
[loader.py](../../mutsuki/core/loader.py)：
...
[loader.py:122-133](../../mutsuki/core/loader.py#L122-L133)：
...
```python
from mutsuki.contracts.plugin import PluginDep
...
```python
from mutsuki.core.loader import PluginCycleError
...
from mutsuki.core.loader import PluginLoadFailedError
