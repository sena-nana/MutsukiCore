...
[agent.py](../../mutsuki/core/agent.py) · 详见 [Agent 与生命周期](../04-guide/agent-and-lifecycle.md)。
...
[agent_registry.py](../../mutsuki/core/agent_registry.py)
...
[context.py](../../mutsuki/core/context.py) · 详见 [AgentContext](../04-guide/agent-context.md)。
...
[plugin.py](../../mutsuki/core/plugin.py) · 详见 [插件定义](../04-guide/plugin-definition.md)。
...
[dependency.py](../../mutsuki/core/dependency.py) · 详见 [依赖注入](../04-guide/dependency-injection.md)。
...
[scope.py](../../mutsuki/core/scope.py) · 详见 [PluginScope](../04-guide/plugin-scope.md) · [TransactionScope 与 Saga](../05-advanced/transaction-scope-saga.md)。
...
[bus.py](../../mutsuki/core/bus.py) · 详见 [事件总线](../04-guide/event-bus.md)。
...
[container.py](../../mutsuki/core/container.py) · 详见 [服务容器](../04-guide/service-container.md)。
...
[handle.py](../../mutsuki/core/handle.py) · 详见 [Handle 与 RefPayload](../04-guide/handle-and-refpayload.md)。
...
[resource_host.py](../../mutsuki/core/resource_host.py) · 详见 [ResourceHost](../04-guide/resource-host.md)。
...
[registry.py](../../mutsuki/core/registry.py)
...
[loader.py](../../mutsuki/core/loader.py) · 详见 [插件 DAG 加载](../05-advanced/plugin-loader-dag.md)。

```python
class PluginLoader:
    def __init__(self, *, entry_point_group="mutsuki.plugins", allow=None) -> None
...
[lifespan.py](../../mutsuki/core/lifespan.py)
...
[saga.py](../../mutsuki/core/saga.py) · 详见 [TransactionScope 与 Saga](../05-advanced/transaction-scope-saga.md)。
...
[capability_guard.py](../../mutsuki/core/capability_guard.py) · 详见 [Capability](../04-guide/capability.md)。
