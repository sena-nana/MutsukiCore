# API · `mutsuki.runtime`（Python reference）

本页描述 `python/reference-mutsuki` 中旧 Python reference runtime 的 API：
...
来源：[mutsuki/runtime/__init__.py](../../mutsuki/runtime/__init__.py)。
...
[clock.py](../../mutsuki/runtime/clock.py)
...
[idgen.py](../../mutsuki/runtime/idgen.py)
...
[scheduler.py](../../mutsuki/runtime/scheduler.py)
...
[backend.py](../../mutsuki/runtime/backend.py)
