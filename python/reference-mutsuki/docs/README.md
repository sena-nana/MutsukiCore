# Mutsuki Python Reference 文档

> 当前文档对应 `python/reference-mutsuki` 中保留的旧 Python framework / plugin host
...
- [什么是 Mutsuki](01-introduction/what-is-mutsuki.md) —— 当前 Rust-first 定位与 Python reference 分层
...
- [`mutsuki`](07-api/mutsuki.md)
- [`mutsuki.contracts`](07-api/contracts.md)
- [`mutsuki.core`](07-api/core.md)
- [`mutsuki.runtime`](07-api/runtime.md)
- [`mutsuki.core.dispatcher`](07-api/dispatcher.md)
- [Transport endpoints](07-api/endpoint.md)
- [`mutsuki.plugins`](07-api/plugins.md)
...
- 凡引用源码都用相对链接，例如 [agent.py:74](../mutsuki/core/agent.py#L74)。
- 类、函数、命令名首次出现用反引号包起来；后续可省。
- 所有代码片段都从 `mutsuki/` 现有实现里截取或仿写，可直接运行。
...
1. 新增 / 删除 / 重命名 `mutsuki/__init__.py` 或 `mutsuki.contracts/__init__.py` 的导出符号
