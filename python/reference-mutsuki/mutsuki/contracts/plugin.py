...
面向用户的高层装饰器（``@command`` 等）位于 :mod:`mutsuki.core.plugin`。
...
from mutsuki.contracts.service import ServiceMode
...
class PluginDep(Contract):
    ...
    schema_id: ClassVar[str] = "mutsuki.plugin_dep"
...
class ContractDep(Contract):
    ...
    schema_id: ClassVar[str] = "mutsuki.contract_dep"
    schema_version: ClassVar[str] = "1.0.0"
...
class ServiceDep(Contract):
    ...
    schema_id: ClassVar[str] = "mutsuki.service_dep"
    schema_version: ClassVar[str] = "1.0.0"
...
class PluginManifest(Contract):
    ...
    schema_id: ClassVar[str] = "mutsuki.plugin_manifest"
    schema_version: ClassVar[str] = "1.0.0"
