...
命令路由统一走 :class:`mutsuki.core.dispatcher.Dispatcher`（详 D12 命令与
...
from mutsuki.contracts.agent_profile import AgentParticipation, AgentProfile
from mutsuki.contracts.envelope import Envelope
from mutsuki.contracts.ids import AgentId, SpanId, TraceId
from mutsuki.contracts.lifecycle import LifecyclePhase
from mutsuki.contracts.scope import ScopeRule
from mutsuki.core.agent_registry import AgentRegistry
from mutsuki.core.bus import Bus
from mutsuki.core.container import ServiceContainer
from mutsuki.core.context import AgentContext, TraceContext
from mutsuki.core.dispatcher import Dispatcher
from mutsuki.core.lifespan import Lifespan
from mutsuki.core.scope import PluginScope

if TYPE_CHECKING:
    from mutsuki.core.dependency import Dependent
    from mutsuki.core.plugin import Plugin
    from mutsuki.runtime.clock import Clock
    from mutsuki.runtime.idgen import IdGen
    from mutsuki.runtime.rng import RNG
...
class Agent:
    ...
    def attach_plugin(self, plugin: "Plugin", scope: PluginScope) -> None:
        ...
        from mutsuki.core.dependency import Dependent
        from mutsuki.core.plugin import _CommandMarker
