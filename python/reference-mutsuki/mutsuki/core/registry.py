...
:mod:`mutsuki.plugins.inmemory_endpoint`）。Source / Operation 注册由
:class:`mutsuki.core.dispatcher.Dispatcher` 在 Agent 内部维护。
"""
...
if TYPE_CHECKING:
    from mutsuki.core.handle import HandleImpl
