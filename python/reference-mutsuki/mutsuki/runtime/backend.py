...
from mutsuki.contracts.agent_profile import StrategyResult, StrategyResultStatus
...
from mutsuki.contracts.ids import AgentId, RefId
from mutsuki.contracts.operation import OperationDescriptor
from mutsuki.contracts.refpayload import RefDescriptor
from mutsuki.contracts.source import SourceDescriptor
...
class OperationHandlerKey(Contract):
    ...
    schema_id: ClassVar[str] = "mutsuki.runtime.operation_handler_key"
...
class OperationSnapshot(Contract):
    ...
    schema_id: ClassVar[str] = "mutsuki.runtime.operation_snapshot"
    schema_version: ClassVar[str] = "1.0.0"
...
class SourceSnapshot(Contract):
    ...
    schema_id: ClassVar[str] = "mutsuki.runtime.source_snapshot"
    schema_version: ClassVar[str] = "1.0.0"
...
class LeaseToken(Contract):
    ...
    schema_id: ClassVar[str] = "mutsuki.runtime.lease_token"
    schema_version: ClassVar[str] = "1.0.0"
...
class ResourceSnapshot(Contract):
    ...
    schema_id: ClassVar[str] = "mutsuki.runtime.resource_snapshot"
    schema_version: ClassVar[str] = "1.0.0"
