...
from mutsuki.contracts.scope import ByCapability, BySchema, BySourceKind, ScopeName
from mutsuki.contracts.source import SourceKindName

_OWNER = "mutsuki_ext.im"
...
class ChannelRef(SourceRef):
    ...
    schema_id: ClassVar[str] = "mutsuki.channel_ref"
...
class ContentPart(Contract):
    ...
    schema_id: ClassVar[str] = "mutsuki.content_part"
    schema_version: ClassVar[str] = "1.0.0"
...
class Message(Envelope):
    ...
    schema_id: ClassVar[str] = "mutsuki.message"
    schema_version: ClassVar[str] = "1.0.0"
...
IMScopes.ANY = ScopeName.register(
    "im.any",
    declared_by=_OWNER,
    rule=BySchema("mutsuki.message") & BySourceKind(IMSourceKinds.IM),
)
