...
from mutsuki.core.handle import (
...
def test_refpayload_generic_specialization_does_not_pollute_schema_registry() -> None:
    ...
    """
    from mutsuki.contracts.base import SchemaRegistry
    from mutsuki.contracts.refpayload import RefPayload
