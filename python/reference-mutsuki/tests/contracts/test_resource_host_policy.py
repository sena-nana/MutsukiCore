...
from mutsuki.contracts import RefId, SchemaRegistry
from mutsuki.contracts.resource_host import (
    ResourceHostPolicyConfig,
    ResourceRecordSelector,
)
from mutsuki.core.resource_host import ResourceRecord


def test_resource_host_policy_contracts_are_registered() -> None:
    assert SchemaRegistry.get("mutsuki.resource_record_selector") is ResourceRecordSelector
    assert SchemaRegistry.get("mutsuki.resource_host_policy") is ResourceHostPolicyConfig
