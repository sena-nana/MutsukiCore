...
[capability.py:25-34](../../mutsukibot/contracts/capability.py#L25-L34)：
...
这让框架核心可以预先注册一组名字（[capability_builtin.py:31-44](../../mutsukibot/contracts/capability_builtin.py#L31-L44)），第三方插件扩展自己的命名空间（如 `yume.vram`）—— 而 `CapabilityName("typo_here")` 这种打字错误会在构造时直接拒掉。

### 内置 Caps 门面

[capability_builtin.py:17-28](../../mutsukibot/contracts/capability_builtin.py#L17-L28)：
...
[capability.py:37-46](../../mutsukibot/contracts/capability.py#L37-L46)：
...
[capability_guard.py:20-36](../../mutsukibot/core/capability_guard.py#L20-L36)：
...
按 [capability_builtin.py](../../mutsukibot/contracts/capability_builtin.py) 的模式建一个门面类，让 IDE 能补全：
