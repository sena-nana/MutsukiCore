# MutsukiBot Python Reference 文档

> 当前文档对应 `python/reference-mutsukibot` 中保留的旧 Python framework / plugin host
...
- [什么是 MutsukiBot](01-introduction/what-is-mutsukibot.md) —— 当前 Rust-first 定位与 Python reference 分层
