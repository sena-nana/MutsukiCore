...
代码：[mutsukicore/core/loader.py](../../mutsukicore/core/loader.py)。
...
[loader.py:77-90](../../mutsukicore/core/loader.py#L77-L90)：
...
约定：`pyproject.toml` 里声明 `[project.entry-points."mutsukicore.plugins"]`：
...
[loader.py](../../mutsukicore/core/loader.py)：
...
[loader.py:122-133](../../mutsukicore/core/loader.py#L122-L133)：
...
```python
from mutsukicore.contracts.plugin import PluginDep
...
```python
from mutsukicore.core.loader import PluginCycleError
...
from mutsukicore.core.loader import PluginLoadFailedError
