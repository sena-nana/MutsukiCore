...
:class:`Caps` 门面让 pyright/IDE 能够准确推断 MutsukiCore 核心 capability 名。
插件应当采用相同模式，自建门面类（例如
...
class Caps:
    """所有 MutsukiCore 框架内置 capability 常量。
...
from mutsukicore_ext.im import IMCaps
