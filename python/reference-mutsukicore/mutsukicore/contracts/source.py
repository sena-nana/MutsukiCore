...
Source 与 Operation（参见 :mod:`mutsukicore.contracts.operation`）共享命名空间
...
from mutsukicore.contracts._registered import RegisteredString
...
class SourceDescriptor(Contract):
    ...
    schema_id: ClassVar[str] = "mutsukicore.source_descriptor"
...
class SourceDep(Contract):
    ...
    schema_id: ClassVar[str] = "mutsukicore.source_dep"
    schema_version: ClassVar[str] = "1.0.0"
