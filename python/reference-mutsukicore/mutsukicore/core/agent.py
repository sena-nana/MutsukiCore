...
命令路由统一走 :class:`mutsukicore.core.dispatcher.Dispatcher`（详 D12 命令与
...
from mutsukicore.contracts.agent_profile import AgentParticipation, AgentProfile
from mutsukicore.contracts.envelope import Envelope
from mutsukicore.contracts.ids import AgentId, SpanId, TraceId
...
from mutsukicore.core.context import AgentContext, TraceContext
from mutsukicore.core.dispatcher import Dispatcher
from mutsukicore.core.lifespan import Lifespan
from mutsukicore.core.scope import PluginScope

if TYPE_CHECKING:
    from mutsukicore.core.dependency import Dependent
    from mutsukicore.core.plugin import Plugin
    from mutsukicore.runtime.clock import Clock
    from mutsukicore.runtime.idgen import IdGen
    from mutsukicore.runtime.rng import RNG
...
class Agent:
    ...
    def attach_plugin(self, plugin: "Plugin", scope: PluginScope) -> None:
        ...
        from mutsukicore.core.dependency import Dependent
        from mutsukicore.core.plugin import _CommandMarker
