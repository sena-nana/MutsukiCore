...
from mutsukicore.contracts.permission import PermissionRule
...
from mutsukicore.core.trace import trace_span
...
class Dispatcher:
    ...
    def list_operation_snapshots(self):
        ...
        """
        from mutsukicore.runtime.backend import (
    ...
    def list_source_snapshots(self):
        ...
        from mutsukicore.runtime.backend import SourceSnapshot
    ...
    async def invoke(
        ...
        *,
        ...
        async with trace_span(
            ...
            from mutsukicore.core.capability_guard import (
