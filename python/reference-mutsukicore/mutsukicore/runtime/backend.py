...
from mutsukicore.contracts.agent_profile import StrategyResult, StrategyResultStatus
...
from mutsukicore.contracts.ids import AgentId, RefId
from mutsukicore.contracts.operation import OperationDescriptor
from mutsukicore.contracts.refpayload import RefDescriptor
from mutsukicore.contracts.source import SourceDescriptor
from mutsukicore.core.dispatcher import OperationInvokeError
from mutsukicore.runtime.envelope_dispatch import dispatch_envelope_to_consumers
...
class OperationHandlerKey(Contract):
    ...
    schema_id: ClassVar[str] = "mutsukicore.runtime.operation_handler_key"
...
class OperationSnapshot(Contract):
    ...
    schema_id: ClassVar[str] = "mutsukicore.runtime.operation_snapshot"
    schema_version: ClassVar[str] = "1.0.0"
...
class SourceSnapshot(Contract):
    ...
    schema_id: ClassVar[str] = "mutsukicore.runtime.source_snapshot"
    schema_version: ClassVar[str] = "1.0.0"
...
class LeaseToken(Contract):
    ...
    schema_id: ClassVar[str] = "mutsukicore.runtime.lease_token"
    schema_version: ClassVar[str] = "1.0.0"
...
class ResourceSnapshot(Contract):
    ...
    schema_id: ClassVar[str] = "mutsukicore.runtime.resource_snapshot"
    schema_version: ClassVar[str] = "1.0.0"
