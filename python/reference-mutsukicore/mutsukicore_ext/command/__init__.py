...
from mutsukicore.contracts.ids import MessageId, SpanId, TraceId
from mutsukicore.core.container import ServiceNotFoundError
from mutsukicore.core.dispatcher import OperationInvokeError
from mutsukicore.core.plugin import Plugin, operation
...
class TextCommandRouterPlugin(Plugin[_TextCommandRouterConfig]):
    ...
    id: ClassVar[str] = "mutsukicore-ext-command-router"
