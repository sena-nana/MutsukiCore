...
from mutsukicore.contracts.scope import ByCapability, BySchema, BySourceKind, ScopeName
from mutsukicore.contracts.source import SourceKindName

_OWNER = "mutsukicore_ext.im"
...
class ChannelRef(SourceRef):
    ...
    schema_id: ClassVar[str] = "mutsukicore.channel_ref"
...
class ContentPart(Contract):
    ...
    schema_id: ClassVar[str] = "mutsukicore.content_part"
    schema_version: ClassVar[str] = "1.0.0"
...
class Message(Envelope):
    ...
    schema_id: ClassVar[str] = "mutsukicore.message"
    schema_version: ClassVar[str] = "1.0.0"
...
IMScopes.ANY = ScopeName.register(
    "im.any",
    declared_by=_OWNER,
    rule=BySchema("mutsukicore.message") & BySourceKind(IMSourceKinds.IM),
)
