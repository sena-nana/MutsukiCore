...
from mutsukicore.core.handle import (
...
def test_refpayload_generic_specialization_does_not_pollute_schema_registry() -> None:
    ...
    """
    from mutsukicore.contracts.base import SchemaRegistry
    from mutsukicore.contracts.refpayload import RefPayload
    ...
    refpayload_entries = [
        ...
        if sid == "mutsukicore.ref_payload"
    ]
