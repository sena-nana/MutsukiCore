...
from mutsukicore.contracts import RefId, SchemaRegistry
from mutsukicore.contracts.resource_host import (
    ResourceHostPolicyConfig,
    ResourceRecordSelector,
)
from mutsukicore.core.resource_host import ResourceRecord


def test_resource_host_policy_contracts_are_registered() -> None:
    assert SchemaRegistry.get("mutsukicore.resource_record_selector") is ResourceRecordSelector
    assert SchemaRegistry.get("mutsukicore.resource_host_policy") is ResourceHostPolicyConfig
